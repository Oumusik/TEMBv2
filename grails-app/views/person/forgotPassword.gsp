...
<body >
    ...
    <div style="display: flex;flex-direction:column;justify-content:center;width: 100%;align-items: center;">
        <g:img src="./verification.svg" alt="" style="width:201px;height:201px;margin-top: 5%;"/>
        <p style="font-family: 'Montserrat';
        font-style: normal;
        font-weight: 500;
        font-size: 15px;
        ...
        color: #414042;
        width: 80%;
        ">Оберіть яку контактну інформацію використати для відновлення паролю</p>
        ...
        border: 2px solid rgba(47, 103, 255, 0.2);
        box-shadow: 2px 0px 20px rgba(24, 57, 107, 0.05);
        border-radius: 32px;
        margin-bottom: 2%;
        width: 85%;
        ">
            <g:img src="./mailIcon.svg" alt=""/>
            <div>
                <p style="font-family: 'Montserrat';
                font-style: normal;
                font-weight: 500;
        ...
        ">
            ...
            <div>
                ...
                align-items: center;
                color: #414042;
                ">Anastasia@gmail.com</p>
            </div>
        </div>
        <button style="background: #2247AF;
        border-radius: 20px;width:92%;font-family: 'Montserrat';
        font-style: normal;
        font-weight: 600;
        font-size: 15.1429px;
        line-height: 23px;
